        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6 md:pr-8">
            ...
            <p className="text-lg text-gray-700">
              Join our global community of changemakers and bring creative Campaigns to life through the power of collective funding.
            </p>
            <div className="flex space-x-4 pt-4">
              <a href="/explore" className="px-6 py-3 bg-[#3366CC] hover:bg-[#2855AA] text-white rounded-lg font-medium transition-colors duration-300 flex items-center">
                explore Campaigns <ArrowRight className="ml-2 h-4 w-4" />
              </a>
              <a href="/start-campaign" className="px-6 py-3 bg-white border-2 border-[#4CAF50] text-[#4CAF50] hover:bg-[#4CAF50]/5 rounded-lg font-medium transition-colors duration-300">
                Start a Campaign
              </a>
            </div>
          </div>
