...
import { CheckCircle, XCircle, Upload, ExternalLink, AlertCircle, Phone, Building2, CreditCard } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Manage your organization's basic information and verification documents
          </p>
        </div>
        {orgProfile && (
        ...
        {orgProfile && (
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
              <div>
                <span className="font-medium text-gray-700">ID:</span> {orgProfile.id}
              </div>
              <div>
                <span className="font-medium text-gray-700">Owner:</span> {orgProfile.owner_email || user?.email || 'N/A'}
              </div>
              <div>
                <span className="font-medium text-gray-700">Created:</span> {new Date(orgProfile.created_at).toLocaleDateString()}
              </div>
              <div>
                <span className="font-medium text-gray-700">Last Updated:</span> {new Date(orgProfile.updated_at).toLocaleDateString()}
              </div>
            </div>
          </div>
        )}
